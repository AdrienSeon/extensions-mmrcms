...
import { Mmrcms } from "..";
import { ManhwasMen } from "../sources/ManhwasMen/ManhwasMen";

describe("ManhwasMen Tests", function () {
	const wrapper: MmrcmsAPIWrapper = new MmrcmsAPIWrapper();
	const source: Mmrcms = new ManhwasMen(cheerio);
