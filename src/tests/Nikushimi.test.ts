...
describe.skip("Nikushimi Tests", function () {
	const wrapper: MmrcmsAPIWrapper = new MmrcmsAPIWrapper();
	const source: Mmrcms = new Nikushimi(cheerio);
	 ...
	 */
	const mangaId = "ouji-ga-watashi-wo-akiramenai"; // ! website not updated anymore
