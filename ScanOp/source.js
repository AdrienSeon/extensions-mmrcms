...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ScanOp = exports.ScanOpInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.ScanOpInfo = {
    version: "1.0.0",
...
class ScanOp extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.ScanOpInfo.name;
        this.baseUrl = exports.ScanOpInfo.websiteBaseURL;
        ...
        this.sourceTags = [{ id: "nouveau", name: "nouveau" }];
    }
}
