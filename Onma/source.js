...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Onma = exports.OnmaInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.OnmaInfo = {
    version: "1.0.0",
...
class Onma extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.OnmaInfo.name;
        this.baseUrl = exports.OnmaInfo.websiteBaseURL;
        this.languageCode = paperback_extensions_common_1.LanguageCode.UNKNOWN; // ! ARABIC enum not implemented
        this.dateFormat = {
            format: "DD/MM/YYYY",
