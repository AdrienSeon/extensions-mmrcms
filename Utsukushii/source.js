...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Utsukushii = exports.UtsukushiiInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.UtsukushiiInfo = {
    version: "1.0.0",
    name: "Utsukushii",
...
class Utsukushii extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.UtsukushiiInfo.name;
        this.baseUrl = exports.UtsukushiiInfo.websiteBaseURL;
        this.languageCode = paperback_extensions_common_1.LanguageCode.RUSSIAN;
        this.dateFormat = {
            format: "DD/MM/YYYY",
            todayTranslation: "сегодня",
            yesterdayTranslation: "вчерашний день",
        };
        this.filterListElementsWrapper = "div.content div.col-sm-6";
        this.sourceCategories = [
            { id: "1", name: "Екшън" },
