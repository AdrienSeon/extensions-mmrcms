...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Remangas = exports.RemangasInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.RemangasInfo = {
    version: "1.0.0",
    name: "Remangas",
...
class Remangas extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.RemangasInfo.name;
        this.baseUrl = exports.RemangasInfo.websiteBaseURL;
        this.languageCode = paperback_extensions_common_1.LanguageCode.PORTUGUESE;
        this.dateFormat = {
            format: "DD/MM/YYYY",
            todayTranslation: "hoje",
            yesterdayTranslation: "ontem",
        };
        this.sourceCategories = [
            { id: "1", name: "Ação" },
            { id: "2", name: "Aventura" },
