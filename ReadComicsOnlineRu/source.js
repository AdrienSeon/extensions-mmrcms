...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReadComicsOnlineRu = exports.ReadComicsOnlineRuInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.ReadComicsOnlineRuInfo = {
    version: "1.0.0",
...
class ReadComicsOnlineRu extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.ReadComicsOnlineRuInfo.name;
        this.baseUrl = exports.ReadComicsOnlineRuInfo.websiteBaseURL;
...
exports.ReadComicsOnlineRu = ReadComicsOnlineRu;

},{"..":29,"paperback-extensions-common":4}],29:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./Mmrcms":26,"./models":33}],30:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
...
},{"./DateFormat":30,"./SourceCategory":31,"./SourceTag":32}]},{},[28])(28)
});
