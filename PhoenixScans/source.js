...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.PhoenixScans = exports.PhoenixScansInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.PhoenixScansInfo = {
    version: "1.0.0",
    name: "Phoenix-Scans",
...
class PhoenixScans extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.PhoenixScansInfo.name;
        this.baseUrl = exports.PhoenixScansInfo.websiteBaseURL;
        this.languageCode = paperback_extensions_common_1.LanguageCode.POLISH;
        this.dateFormat = {
            format: "DD/MM/YYYY",
...
exports.PhoenixScans = PhoenixScans;
