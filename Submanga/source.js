...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Submanga = exports.SubmangaInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const __1 = require("..");
exports.SubmangaInfo = {
    version: "1.0.0",
    name: "Submanga",
...
class Submanga extends __1.Mmrcms {
    constructor() {
        super(...arguments);
        this.name = exports.SubmangaInfo.name;
        this.baseUrl = exports.SubmangaInfo.websiteBaseURL;
        ...
        this.latestIsInListFormat = false;
        this.sourceCategories = [
            { id: "1", name: "Accion" },
            { id: "2", name: "Aventura" },
            { id: "3", name: "Comedia" },
