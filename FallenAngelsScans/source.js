...
class FallenAngelsScans extends Mmrcms_1.Mmrcms {
    constructor() {
        super(...arguments);
        this.baseUrl = FALLENANGELSSCANS_DOMAIN;
...
},{"../Mmrcms":27,"paperback-extensions-common":4}],27:[function(require,module,exports){
"use strict";
...
class Mmrcms extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        /**
         * The path that precedes a manga page not including the mMRCMS url.
         * Eg. for https://submanga.io/manga/domestic-na-kanojo/ it would be 'manga'.
         * Used in all functions.
         */
        this.sourceTraversalPathName = "manga";
        /**
         * Array of corresponding ids and categories for this mMRCMS url.
         */
        this.categories = []; // TODO interface a faire
        /**
         * Array of corresponding ids and tags for this mMRCMS url.
         */
        this.tags = []; // TODO interface a faire
        /**
            ...
            const sections = [
                {
                    request: createRequestObject({
                        ...
                        method: "GET",
                        headers: this.constructHeaders({}, `/latest-release`),
                    }),
                ...
                },
                {
                    request: createRequestObject({
                        ...
                        method: "GET",
                        headers: this.constructHeaders({}, `/filterList?page=1&sortBy=views&asc=false`),
                    }),
                    section: createHomeSection({
...
class Parser {
    ...
    parseHomeSections($, source, sectionId) {
        let mangaTiles = [];
    ...
    parseFilterList($, source) {
        ...
        for (const element of $(".media").toArray()) {
            id = (_b = ((_a = $("a.chart-title", element).attr("href")) !== null && _a !== void 0 ? _a : "").split("/").pop()) !== null && _b !== void 0 ? _b : "";
            image = `${source.baseUrl}/uploads/manga/${id}/cover/cover_250x350.jpg`;
